const LINKS = [
    {name: "Paper", link: "https://www.sciencedirect.com/science/article/pii/S2666017225001129?via%3Dihub", icon: "fas fa-file-pdf"},
    {name: "Datasheet", link: "papers/NacalaRoofMaterialDatasheet.pdf", icon: "fas fa-file-pdf"},
