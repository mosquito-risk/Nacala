...
if __name__ == '__main__':
    ...
    parser.add_argument("--keyword", type=str, help="Unique name for run", default="test")
    parser.add_argument("--model_name", type=str, help="Model from load_models.py", default="unet_2heads")
    parser.add_argument("--label2_folder", type=str, help="Second head labels", default="dist_mask")
    parser.add_argument("--load_data2device", type=str, help="load data to CPU/GPU memory", default="cuda")
    parser.add_argument("--loss_type", type=str, help="see loss_functions.py", default="cross_entropy")
    parser.add_argument("--head_size", type=str, help="Size of head for 2heads models", default="n")
    parser.add_argument("--data_path", type=str, help="Path to data folders", default='./data/sample/')
    parser.add_argument("--val_folder", type=str, help="Validation folder name", default="valid")
    parser.add_argument("--tensordata_folder", type=str, help="Directory to save tensors",
                        default="./input")
    ...
    parser.add_argument("--sample_size", type=int, help="sample size test run", default=None)
    ...
    parser.add_argument("--pixel_dist", type=int, help="Training epochs", default=None)
    ...
    params['pixel_dist'] = args.pixel_dist
