...
from pipelines.models.decoders import UnetDecoder
...
class Unet(SegmentationModel):
    ...
    def __init__(
        ...
        if classes2 is None:
            self.num_classes2 = classes
        else:
            self.num_classes2 = classes2
        ...
        self.segmentation_head2 = SegmentationHead2(
            in_channels=decoder_channels[-1],
            out_channels=self.num_classes2,
            activation=activation,
            kernel_size=3,
    ...
    def forward(self, x):
        ...
        masks1 = self.segmentation_head1(decoder_output)
